        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse d-flex justify-content-between px-2" id="navbarNavDropdown">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item ">
                        <a class="nav-link" aria-current="page" href="#">User / Pelanggan</a>
                    </li>
                    <li class="nav-item ">
                    ...
                    <li class="nav-item ">
                        <a class="nav-link" aria-current="page" href="#">Daftar Booking</a>
                    </li>
                    <li class="nav-item ">
                        <a class="nav-link" aria-current="page" href="#">Peminjaman / Pengembalian</a>
                    </li>
